...
#pragma once
#ifndef _EDK_CORE_MEMORY_STATIC_ALLOCATOR_H
#define _EDK_CORE_MEMORY_STATIC_ALLOCATOR_H

/**
 * Static Memory Allocator for the EDK
 */
...
namespace EDK
{
	 ...
	 */
	template<class Type, UI64 DefaultAligment = EDK_ALIGNMENT>
	...
	public:
		 ...
		 */
		EDK_FORCEINLINE static PTR RawAllocate(UI64 byteSize = sizeof(Type), UI64 alignment = DefaultAligment, UI64 offset = 0)
		{
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static PTR Allocate(UI64 byteSize = sizeof(Type), UI64 alignment = DefaultAligment, UI64 offset = 0)
		{
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static PTR AllocateInit(const Type& initData, UI64 byteSize = sizeof(Type), UI64 alignment = DefaultAligment, UI64 offset = 0)
		{
			PTR _ptr = RawAllocation(byteSize, alignment, offset);
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static void RawDeallocate(PTR location, UI64 byteSize = sizeof(Type), UI64 alignment = DefaultAligment, UI64 offset = 0)
		{
			if (byteSize)
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static void Deallocate(PTR location, UI64 byteSize = sizeof(Type), UI64 alignment = DefaultAligment, UI64 offset = 0)
		{
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static void DeallocateRange(PTR begin, PTR end)
		{
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static PTR AllocateArr(UI64 byteSize = sizeof(Type), UI64 alignment = DefaultAligment, UI64 offset = 0)
		{
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static void DeallocateArr(PTR location, UI64 byteSize = sizeof(Type), UI64 alignment = DefaultAligment, UI64 offset = 0)
		{
			if (byteSize)
				operator delete[](location, byteSize, std::align_val_t{ alignment });
			else
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static void DeallocateArrRange(PTR begin, PTR end)
		{
			operator delete[](begin, end);
		}
	...
	private:
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static PTR RawAllocation(UI64 byteSize, UI64 alignment, UI64 offset)
		{
			try
			{
		 ...
		 * @return: The newly allocated block.
		 */
		EDK_FORCEINLINE static PTR RawAllocationArr(UI64 byteSize, UI64 alignment, UI64 offset)
		{
			try
			{
				auto __newAddr = operator new[](byteSize, std::align_val_t{ alignment });
...
#endif // !_EDK_CORE_MEMORY_STATIC_ALLOCATOR_H
