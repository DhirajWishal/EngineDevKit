...
#pragma once
#ifndef _EDK_DATA_TypeS_H
#define _EDK_DATA_TypeS_H
...
/**
 * EDK Data Types.
 * This file contains all the necessary data types and enums used in the EDK.
 */
...
{
	/**
	 * This contains all the virtual data types for the EDK.
	 */
	...
	/**
	 * This contains all the formats supported by the EDK.
	 * R = Red,
	 * G = Green,
	 * B = Blue,
	 * A = Alpha
