...
#pragma once
#ifndef _EDK_INPUTS_MOUSE_INPUT_SUPPLIER_H
#define _EDK_INPUTS_MOUSE_INPUT_SUPPLIER_H
...
namespace EDK
{
	namespace Inputs
	{
		...
		/**
		 * Mouse Input Supplier for the EDK Enigne.
...
#endif // !_EDK_INPUTS_MOUSE_INPUT_SUPPLIER_H
