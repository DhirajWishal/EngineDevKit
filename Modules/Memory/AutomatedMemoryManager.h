...
#pragma once
#ifndef _EDK_CORE_MEMORY_AUTOMATED_MEMORY_MANAGER_H
#define _EDK_CORE_MEMORY_AUTOMATED_MEMORY_MANAGER_H
...
namespace EDK
{
	namespace Memory
	{
		 ...
		 * This structure keeps track on all the memory allocations done by the EDK and terminates all the memory blocks
		...
		class AutomatedMemoryManager {
			...
			static AutomatedMemoryManager instance;	// Static instance.
...
#endif // !_EDK_CORE_MEMORY_AUTOMATED_MEMORY_MANAGER_H
