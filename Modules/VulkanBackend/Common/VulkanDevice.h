...
#pragma once
#ifndef _EDK_VULKAN_BACKEND_DEVICE_H
#define _EDK_VULKAN_BACKEND_DEVICE_H
	...
	namespace Graphics
	{
		namespace VulkanBackend
		{
			...
			public:
				 ...
				 */
				EDK_FORCEINLINE std::optional<UI32> GetGraphicsFamily() const { return graphicsFamily; }
				 ...
				 * @return: std::optional<UI32> object.
				 */
				EDK_FORCEINLINE std::optional<UI32> GetComputeFamily() const { return computeFamily; }
				 ...
				 * @return: std::optional<UI32> object.
				 */
				EDK_FORCEINLINE std::optional<UI32> GetTransferFamily() const { return transferFamily; }
				 ...
				 */
				EDK_FORCEINLINE VkQueue GetGraphicsQueue() const { return vGraphicsQueue; }
				 ...
				 * @return: VkQueue handle.
				 */
				EDK_FORCEINLINE VkQueue GetComputeQueue() const { return vComputeQueue; }
			...
			public:
				 ...
				 */
				EDK_FORCEINLINE GLFWwindow* GetWindowHandle() const { return pWindowHandle; }
				 ...
				 */
				EDK_FORCEINLINE VkSurfaceKHR GetSurface() const { return vSurface; }
				 ...
				 */
				EDK_FORCEINLINE VkPhysicalDevice GetPhysicalDevice() const { return vPhysicalDevice; }
				 ...
				 */
				EDK_FORCEINLINE VkDevice GetLogicalDevice() const { return vLogicalDevice; }
			...
			public:
				 ...
				 */
				EDK_FORCEINLINE VkPhysicalDeviceProperties GetPhysicalDeviceProperties() const { return vPhysicalDeviceProperties; }
				 ...
				 */
				EDK_FORCEINLINE VkPhysicalDeviceRayTracingPropertiesKHR GetPhysicalDeviceRayTracingProperties() const { return vPhysicalDeviceRayTracingProperties; }
				 ...
				 */
				EDK_FORCEINLINE VkPhysicalDeviceRayTracingFeaturesKHR GetPhysicalDeviceRayTracingFeatures() const { return vPhysicalDeviceRayTracingFeatures; }
...
#endif // !_EDK_VULKAN_BACKEND_DEVICE_H
