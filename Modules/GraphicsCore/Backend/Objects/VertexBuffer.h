...
#pragma once
#ifndef _EDK_GRAPHICS_CORE_VERTEX_BUFFER_H
#define _EDK_GRAPHICS_CORE_VERTEX_BUFFER_H
...
namespace EDK
{
	namespace GraphicsCore
	{
		 ...
		 *
		 * EDK uses the EDK::Format enum to define the data format of the attribute.
		 */
		...
		/**
		 * Vertex Buffer base class for the EDK.
		...
		/**
		 * Vertex Buffer Reference for the EDK.
...
#endif // !_EDK_GRAPHICS_CORE_VERTEX_BUFFER_H
