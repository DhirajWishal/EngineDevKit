...
#pragma once
#ifndef _EDK_GRAPHCIS_CORE_TEXTURE_H
#define _EDK_GRAPHCIS_CORE_TEXTURE_H
...
namespace EDK
{
	namespace Graphics
	{
		...
		/**
		 * Base class for all the supported texture objects in EDK.
		 */
...
#endif // !_EDK_GRAPHCIS_CORE_TEXTURE_H
