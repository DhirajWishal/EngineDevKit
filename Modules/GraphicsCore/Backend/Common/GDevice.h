...
namespace EDK
{
	namespace GraphicsCore
	{
		...
		struct ViewPort {
			 ...
			 */
			EDK_FORCEINLINE void SetDevice(class GDevice* pDevice) { this->pDevice = pDevice; }
			 ...
			 */
			EDK_FORCEINLINE class GDevice* GetDevice() const { this->pDevice; }
			 ...
			 */
			EDK_FORCEINLINE void SetOffsets(float xOffset, float yOffset) { this->xOffset = xOffset, this->yOffset = yOffset; }
			 ...
			 */
			EDK_FORCEINLINE std::pair<float, float> GetOffsets() const { return { xOffset, yOffset }; }
			 ...
			 */
			EDK_FORCEINLINE void SetSize(UI32 width, UI32 height) { this->width = width, this->height = height; }
			 ...
			 */
			EDK_FORCEINLINE std::pair<UI32, UI32> GetSize() { return { width, height }; }
		...
		public:
			 ...
			 */
			EDK_FORCEINLINE DeviceInitInfo GetInitInfo() const { return initInfo; }
			 ...
			 */
			EDK_FORCEINLINE std::pair<UI32, UI32> GetDisplayExtent() const { return { GetInitInfo().windowWidth, GetInitInfo().windowHeight }; }
...
#endif // !_EDK_GRAPHICS_CORE_DEVICE_H
